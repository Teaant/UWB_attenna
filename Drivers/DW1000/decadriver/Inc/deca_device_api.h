...
typedef void (*dwt_cb_t)(const dwt_cb_data_t *, DW1000_Port_t *);
 ...
 * return int (1 or 0)
 */
int dwt_getgpiovalue(uint32 , DW1000_Port_t *antenna_port);
 ...
 * no return value
 */
void dwt_setrxantennadelay(uint16 antennaDly, DW1000_Port_t *antenna_port);
 ...
 * no return value
 */
void dwt_settxantennadelay(uint16 antennaDly, DW1000_Port_t *antenna_port);
 ...
 * no return value
 */
void dwt_enableframefilter(uint16 bitmask, DW1000_Port_t *antenna_port);
 ...
 * no return value
 */
void dwt_readaccdata(uint8 *buffer, uint16 length, uint16 rxBufferOffset, DW1000_Port_t *antenna_port);
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
int writetospi(uint16 headerLength, const uint8 *headerBuffer, uint32 bodylength, const uint8 *bodyBuffer, DW1000_Port_t *antenna_port);
 ...
 */
int readfromspi(uint16 headerLength, const uint8 *headerBuffer, uint32 readlength, uint8 *readBuffer, DW1000_Port_t *antenna_port);
 ...
 * returns the state of the DW1000 interrupt
 */
void decamutexoff(decaIrqStatus_t s, DW1000_Port_t *antenna_port) ;
